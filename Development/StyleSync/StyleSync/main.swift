...
let sketchDocumentPathString = commandLineArguments[1]
let projectDirectoryPathString = commandLineArguments[2]
let exportDirectoryPathString = commandLineArguments[3]
...
let iOSSwiftColorStyleTemplateURL = URL(fileURLWithPath: "/Users/dylanslewis/Developer/StyleSync/Development/StyleSync/StyleSync/Templates/ColorStyles/iOSSwift")
...
let iOSSwiftTextStyleTemplateURL = URL(fileURLWithPath: "/Users/dylanslewis/Developer/StyleSync/Development/StyleSync/StyleSync/Templates/TextStyles/iOSSwift")
...
var generatedColorStylesFilePath = exportDirectoryPath
	.appendingPathComponent("ColorStyles")
	.appendingPathExtension(colorStyleCodeGenerator.fileExtension)

var generatedTextStylesFilePath = exportDirectoryPath
